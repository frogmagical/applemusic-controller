...
- **音声処理**: [Signalsmith Stretch](https://github.com/Signalsmith-Audio/signalsmith-stretch)([python-stretch](https://pypi.org/project/python-stretch/) バインディング)
...
├── dsp.py       # Signalsmith Stretch ラッパー(キー/ピッチ/テンポ)
